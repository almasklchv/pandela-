    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shapka', models.ImageField(default=None, max_length=512, upload_to='shapki/', verbose_name='Шапка Профиля')),
                ('dp', models.ImageField(default='profiles/writer.png', upload_to='profiles/', verbose_name='Аватарка')),
